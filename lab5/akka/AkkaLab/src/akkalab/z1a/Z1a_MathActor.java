...
public class Z1a_MathActor extends AbstractActor {
    ...
    public void preStart() throws Exception {
        context().actorOf(Props.create(Z1a_MultiplyWorker.class), "multiplyWorker");
        context().actorOf(Props.create(Z1a_DivideWorker.class), "divideWorker");
    }
