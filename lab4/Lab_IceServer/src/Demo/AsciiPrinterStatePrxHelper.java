 ...
 **/
public final class AsciiPrinterStatePrxHelper extends Ice.ObjectPrxHelperBase implements AsciiPrinterStatePrx
{
                                    ...
                                    new IceInternal.Functional_TwowayCallbackArg1<String>(__responseCb, __exceptionCb, __sentCb)
                                        {
                                            ...
                                            {
                                                AsciiPrinterStatePrxHelper.__formatToString_completed(this, __result);
                                            }
                                        });
    }
     ...
     **/
    public static AsciiPrinterStatePrx checkedCast(Ice.ObjectPrx __obj)
    {
        return checkedCastImpl(__obj, ice_staticId(), AsciiPrinterStatePrx.class, AsciiPrinterStatePrxHelper.class);
    }
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     **/
    public static AsciiPrinterStatePrx checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        return checkedCastImpl(__obj, __ctx, ice_staticId(), AsciiPrinterStatePrx.class, AsciiPrinterStatePrxHelper.class);
    }
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     **/
    public static AsciiPrinterStatePrx checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        return checkedCastImpl(__obj, __facet, ice_staticId(), AsciiPrinterStatePrx.class, AsciiPrinterStatePrxHelper.class);
    }
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     **/
    public static AsciiPrinterStatePrx checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        return checkedCastImpl(__obj, __facet, __ctx, ice_staticId(), AsciiPrinterStatePrx.class, AsciiPrinterStatePrxHelper.class);
    }
     ...
     **/
    public static AsciiPrinterStatePrx uncheckedCast(Ice.ObjectPrx __obj)
    {
        return uncheckedCastImpl(__obj, AsciiPrinterStatePrx.class, AsciiPrinterStatePrxHelper.class);
    }
     ...
     * @return A proxy for this type.
     **/
    public static AsciiPrinterStatePrx uncheckedCast(Ice.ObjectPrx __obj, String __facet)
    {
        return uncheckedCastImpl(__obj, __facet, AsciiPrinterStatePrx.class, AsciiPrinterStatePrxHelper.class);
    }
    ...
    public static void __write(IceInternal.BasicStream __os, AsciiPrinterStatePrx v)
    {
        __os.writeProxy(v);
    }

    public static AsciiPrinterStatePrx __read(IceInternal.BasicStream __is)
    {
        Ice.ObjectPrx proxy = __is.readProxy();
        if(proxy != null)
        {
            AsciiPrinterStatePrxHelper result = new AsciiPrinterStatePrxHelper();
