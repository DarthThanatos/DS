 ...
 **/
public final class DeviceStatePrxHelper extends Ice.ObjectPrxHelperBase implements DeviceStatePrx
{
                                    ...
                                    new IceInternal.Functional_TwowayCallbackArg1<String>(__responseCb, __exceptionCb, __sentCb)
                                        {
                                            ...
                                            {
                                                DeviceStatePrxHelper.__formatToString_completed(this, __result);
                                            }
                                        });
    }
     ...
     **/
    public static DeviceStatePrx checkedCast(Ice.ObjectPrx __obj)
    {
        return checkedCastImpl(__obj, ice_staticId(), DeviceStatePrx.class, DeviceStatePrxHelper.class);
    }
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     **/
    public static DeviceStatePrx checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        return checkedCastImpl(__obj, __ctx, ice_staticId(), DeviceStatePrx.class, DeviceStatePrxHelper.class);
    }
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     **/
    public static DeviceStatePrx checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        return checkedCastImpl(__obj, __facet, ice_staticId(), DeviceStatePrx.class, DeviceStatePrxHelper.class);
    }
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     **/
    public static DeviceStatePrx checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        return checkedCastImpl(__obj, __facet, __ctx, ice_staticId(), DeviceStatePrx.class, DeviceStatePrxHelper.class);
    }
     ...
     **/
    public static DeviceStatePrx uncheckedCast(Ice.ObjectPrx __obj)
    {
        return uncheckedCastImpl(__obj, DeviceStatePrx.class, DeviceStatePrxHelper.class);
    }
     ...
     * @return A proxy for this type.
     **/
    public static DeviceStatePrx uncheckedCast(Ice.ObjectPrx __obj, String __facet)
    {
        return uncheckedCastImpl(__obj, __facet, DeviceStatePrx.class, DeviceStatePrxHelper.class);
    }
    ...
    public static void __write(IceInternal.BasicStream __os, DeviceStatePrx v)
    {
        __os.writeProxy(v);
    }

    public static DeviceStatePrx __read(IceInternal.BasicStream __is)
    {
        Ice.ObjectPrx proxy = __is.readProxy();
        if(proxy != null)
        {
            DeviceStatePrxHelper result = new DeviceStatePrxHelper();
