 ...
 **/
public final class SensorStatePrxHelper extends Ice.ObjectPrxHelperBase implements SensorStatePrx
{
                                    ...
                                    new IceInternal.Functional_TwowayCallbackArg1<String>(__responseCb, __exceptionCb, __sentCb)
                                        {
                                            ...
                                            {
                                                SensorStatePrxHelper.__formatToString_completed(this, __result);
                                            }
                                        });
    }
     ...
     **/
    public static SensorStatePrx checkedCast(Ice.ObjectPrx __obj)
    {
        return checkedCastImpl(__obj, ice_staticId(), SensorStatePrx.class, SensorStatePrxHelper.class);
    }
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     **/
    public static SensorStatePrx checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        return checkedCastImpl(__obj, __ctx, ice_staticId(), SensorStatePrx.class, SensorStatePrxHelper.class);
    }
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     **/
    public static SensorStatePrx checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        return checkedCastImpl(__obj, __facet, ice_staticId(), SensorStatePrx.class, SensorStatePrxHelper.class);
    }
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     **/
    public static SensorStatePrx checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        return checkedCastImpl(__obj, __facet, __ctx, ice_staticId(), SensorStatePrx.class, SensorStatePrxHelper.class);
    }
     ...
     **/
    public static SensorStatePrx uncheckedCast(Ice.ObjectPrx __obj)
    {
        return uncheckedCastImpl(__obj, SensorStatePrx.class, SensorStatePrxHelper.class);
    }
     ...
     * @return A proxy for this type.
     **/
    public static SensorStatePrx uncheckedCast(Ice.ObjectPrx __obj, String __facet)
    {
        return uncheckedCastImpl(__obj, __facet, SensorStatePrx.class, SensorStatePrxHelper.class);
    }
    ...
    public static void __write(IceInternal.BasicStream __os, SensorStatePrx v)
    {
        __os.writeProxy(v);
    }

    public static SensorStatePrx __read(IceInternal.BasicStream __is)
    {
        Ice.ObjectPrx proxy = __is.readProxy();
        if(proxy != null)
        {
            SensorStatePrxHelper result = new SensorStatePrxHelper();
