...
public abstract class _AsciiPrinterDisp extends Ice.ObjectImpl implements AsciiPrinter
{
    protected void
    ...
    public static Ice.DispatchStatus ___prettyPrint(AsciiPrinter __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
    ...
    public Ice.DispatchStatus __dispatch(IceInternal.Incoming in, Ice.Current __current)
    {
        ...
        switch(pos)
        {
            ...
            case 1:
            {
                return _PrinterDisp.___fillInk(this, in, __current);
            }
            case 2:
            {
