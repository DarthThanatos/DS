...
public final class SensorPrxHelper extends Ice.ObjectPrxHelperBase implements SensorPrx
{
                             ...
                             new IceInternal.Functional_TwowayCallbackArg1<String>(__responseCb, __exceptionCb, __sentCb)
                                 {
                                     ...
                                     {
                                         SensorPrxHelper.__getName_completed(this, __result);
                                     }
                                 });
    }
                              ...
                              new IceInternal.Functional_TwowayCallbackArg1<String>(__responseCb, __exceptionCb, __sentCb)
                                  {
                                      public final void __completed(Ice.AsyncResult __result)
                                      {
                                          SensorPrxHelper.__getState_completed(this, __result);
                                      }
                                  });
    }
                                 ...
                                 new IceInternal.Functional_TwowayCallbackArg1<String[]>(__responseCb, __exceptionCb, __sentCb)
                                     {
                                         public final void __completed(Ice.AsyncResult __result)
                                         {
                                             SensorPrxHelper.__listActions_completed(this, __result);
                                         }
                                     });
    }
                                   ...
                                   new IceInternal.Functional_TwowayCallbackVoidUE(__responseCb, __userExceptionCb, __exceptionCb, __sentCb)
                                       {
                                           public final void __completed(Ice.AsyncResult __result)
                                           {
                                               SensorPrxHelper.__measureMotion_completed(this, __result);
                                           }
                                       });
    }
     ...
     **/
    public static SensorPrx checkedCast(Ice.ObjectPrx __obj)
    {
        return checkedCastImpl(__obj, ice_staticId(), SensorPrx.class, SensorPrxHelper.class);
    }
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     **/
    public static SensorPrx checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        return checkedCastImpl(__obj, __ctx, ice_staticId(), SensorPrx.class, SensorPrxHelper.class);
    }
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     **/
    public static SensorPrx checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        return checkedCastImpl(__obj, __facet, ice_staticId(), SensorPrx.class, SensorPrxHelper.class);
    }
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     **/
    public static SensorPrx checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        return checkedCastImpl(__obj, __facet, __ctx, ice_staticId(), SensorPrx.class, SensorPrxHelper.class);
    }
     ...
     **/
    public static SensorPrx uncheckedCast(Ice.ObjectPrx __obj)
    {
        return uncheckedCastImpl(__obj, SensorPrx.class, SensorPrxHelper.class);
    }
     ...
     * @return A proxy for this type.
     **/
    public static SensorPrx uncheckedCast(Ice.ObjectPrx __obj, String __facet)
    {
        return uncheckedCastImpl(__obj, __facet, SensorPrx.class, SensorPrxHelper.class);
    }
    ...
    public static void __write(IceInternal.BasicStream __os, SensorPrx v)
    {
        __os.writeProxy(v);
    }

    public static SensorPrx __read(IceInternal.BasicStream __is)
    {
