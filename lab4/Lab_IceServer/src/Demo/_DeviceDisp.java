...
public abstract class _DeviceDisp extends Ice.ObjectImpl implements Device
{
    ...
    public static Ice.DispatchStatus ___feedBattery(Device __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.readEmptyParams();
        __obj.feedBattery(__current);
    ...
    public Ice.DispatchStatus __dispatch(IceInternal.Incoming in, Ice.Current __current)
    {
        ...
        switch(pos)
        {
            case 0:
            {
                return ___feedBattery(this, in, __current);
            }
            case 1:
            {
