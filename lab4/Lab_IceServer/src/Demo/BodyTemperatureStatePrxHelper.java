 ...
 **/
public final class BodyTemperatureStatePrxHelper extends Ice.ObjectPrxHelperBase implements BodyTemperatureStatePrx
{
                                    ...
                                    new IceInternal.Functional_TwowayCallbackArg1<String>(__responseCb, __exceptionCb, __sentCb)
                                        {
                                            ...
                                            {
                                                BodyTemperatureStatePrxHelper.__formatToString_completed(this, __result);
                                            }
                                        });
    }
     ...
     **/
    public static BodyTemperatureStatePrx checkedCast(Ice.ObjectPrx __obj)
    {
        return checkedCastImpl(__obj, ice_staticId(), BodyTemperatureStatePrx.class, BodyTemperatureStatePrxHelper.class);
    }
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     **/
    public static BodyTemperatureStatePrx checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        return checkedCastImpl(__obj, __ctx, ice_staticId(), BodyTemperatureStatePrx.class, BodyTemperatureStatePrxHelper.class);
    }
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     **/
    public static BodyTemperatureStatePrx checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        return checkedCastImpl(__obj, __facet, ice_staticId(), BodyTemperatureStatePrx.class, BodyTemperatureStatePrxHelper.class);
    }
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     **/
    public static BodyTemperatureStatePrx checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        return checkedCastImpl(__obj, __facet, __ctx, ice_staticId(), BodyTemperatureStatePrx.class, BodyTemperatureStatePrxHelper.class);
    }
     ...
     **/
    public static BodyTemperatureStatePrx uncheckedCast(Ice.ObjectPrx __obj)
    {
        return uncheckedCastImpl(__obj, BodyTemperatureStatePrx.class, BodyTemperatureStatePrxHelper.class);
    }
     ...
     * @return A proxy for this type.
     **/
    public static BodyTemperatureStatePrx uncheckedCast(Ice.ObjectPrx __obj, String __facet)
    {
        return uncheckedCastImpl(__obj, __facet, BodyTemperatureStatePrx.class, BodyTemperatureStatePrxHelper.class);
    }
    ...
    public static void __write(IceInternal.BasicStream __os, BodyTemperatureStatePrx v)
    {
        __os.writeProxy(v);
    }

    public static BodyTemperatureStatePrx __read(IceInternal.BasicStream __is)
    {
        Ice.ObjectPrx proxy = __is.readProxy();
        if(proxy != null)
        {
            BodyTemperatureStatePrxHelper result = new BodyTemperatureStatePrxHelper();
