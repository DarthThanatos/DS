 ...
 **/
public final class MoistureSensorStatePrxHelper extends Ice.ObjectPrxHelperBase implements MoistureSensorStatePrx
{
                                    ...
                                    new IceInternal.Functional_TwowayCallbackArg1<String>(__responseCb, __exceptionCb, __sentCb)
                                        {
                                            ...
                                            {
                                                MoistureSensorStatePrxHelper.__formatToString_completed(this, __result);
                                            }
                                        });
    }
     ...
     **/
    public static MoistureSensorStatePrx checkedCast(Ice.ObjectPrx __obj)
    {
        return checkedCastImpl(__obj, ice_staticId(), MoistureSensorStatePrx.class, MoistureSensorStatePrxHelper.class);
    }
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     **/
    public static MoistureSensorStatePrx checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        return checkedCastImpl(__obj, __ctx, ice_staticId(), MoistureSensorStatePrx.class, MoistureSensorStatePrxHelper.class);
    }
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     **/
    public static MoistureSensorStatePrx checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        return checkedCastImpl(__obj, __facet, ice_staticId(), MoistureSensorStatePrx.class, MoistureSensorStatePrxHelper.class);
    }
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     **/
    public static MoistureSensorStatePrx checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        return checkedCastImpl(__obj, __facet, __ctx, ice_staticId(), MoistureSensorStatePrx.class, MoistureSensorStatePrxHelper.class);
    }
     ...
     **/
    public static MoistureSensorStatePrx uncheckedCast(Ice.ObjectPrx __obj)
    {
        return uncheckedCastImpl(__obj, MoistureSensorStatePrx.class, MoistureSensorStatePrxHelper.class);
    }
     ...
     * @return A proxy for this type.
     **/
    public static MoistureSensorStatePrx uncheckedCast(Ice.ObjectPrx __obj, String __facet)
    {
        return uncheckedCastImpl(__obj, __facet, MoistureSensorStatePrx.class, MoistureSensorStatePrxHelper.class);
    }
    ...
    public static void __write(IceInternal.BasicStream __os, MoistureSensorStatePrx v)
    {
        __os.writeProxy(v);
    }

    public static MoistureSensorStatePrx __read(IceInternal.BasicStream __is)
    {
        Ice.ObjectPrx proxy = __is.readProxy();
        if(proxy != null)
        {
            MoistureSensorStatePrxHelper result = new MoistureSensorStatePrxHelper();
